<div class="contain">
    <div class="header_content">
        <a href="/" class="logo">
            <img class="mark" src="/img/logomark.min.svg" alt="hoangvu">
            {{--                <img class="type" src="/img/logotype.min.svg" alt="hoangvu">--}}
        ...
        <nav class="main">
            <div class="nav_contain">
                <ul>
                    ...
                    <li class="resources_link"><a href="/" class="news_">Tin tức</a></li>
                    <li class="partners_link"><a href="/" class="contact_">Liên hệ</a></li>
                </ul>
            </div>
        </nav>
        @include('components.layouts.frontend.search')
