<div class="contain">
    <div class="content-header-top_">
        ...
        <div class="slider-holder_ right-menu-header-top_">
            <div class="image-holder_">
                <img src="https://66.media.tumblr.com/a8e3c2a519fa0bfad2f9c562dd33ccc0/tumblr_pvjg6bpkKe1rogvb0o1_1280.jpg" class="slider-image_" />
                <img src="https://66.media.tumblr.com/9cea6215dc83cd113d1d0d485636eb19/tumblr_psieapK3X01rogvb0o1_1280.jpg" class="slider-image_" />
                <img src="https://66.media.tumblr.com/02bf725cc58f7012fed1a78e33e9e9f3/tumblr_psiealE4b31rogvb0o1_1280.jpg" class="slider-image_" />
            </div>
            <div class="slider-button-holder_">
                    <div class="slider-image-dot_ active-slide_" ref="1" onclick="currentDiv(1, this)"></div>
            ...
            <div class="control-scroll-product_" id="header-control-scroll-product_">
                <div class="prev-scroll-product_" onclick="plusDivs(-1)"><img src="{{asset('img/icons/prev.svg')}}"></div>
                <div class="next-scroll-product_" onclick="plusDivs(1)"><img src="{{asset('img/icons/next.svg')}}"></div>
            </div>
        </div>
    </div>
</div>
<div class="contain">
    <div class="partners_block content_block bg_left">
        <div class="bg">
            <img src="https://66.media.tumblr.com/8d86774c82a41fbea03c9b2749f59d73/tumblr_prw6u0AmjP1rogvb0o1_1280.jpg">
        </div>
                ...
                <div class="items-product-hot_">
                    ...
                    <div class="hot-product_">
                        <div class="content-product_">
                            ...
                            <h5 class="name-product_">Tên sản phẩm Tên sản phẩm Tên sản phẩm Tên sản phẩm</h5>
                            <p class="price_">Giá: <b>150.000 vnđ</b></p>
                            <a href="/" class="learn_more">Xem chi tiết sản phẩm <span>→</span></a>
                        </div>
                    </div>
            ...
            @for($i = 0; $i<=4; $i++)
                <li>
                    <div class="content position-relative_">
                        ...
                        <p class="price_">Giá: <b>150.000 ₫</b> <span class="product-sale_">10.690.000 ₫</span></p>
                        <a href="/" class="learn_more">Xem chi tiết sản phẩm <span>→</span></a>
                    </div>
                </li>
                <li>
