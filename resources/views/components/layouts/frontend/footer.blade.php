        ...
        <div class="footer_bg">
            <div class="contain">
                <div class="footer_content">
                    <div class="logotype">
                        <p class="text-copyright-outline_">mynghehoangvu.com.vn</p>
                    </div>
                ...
                <div class="footer_content">
                    <div class="footer_nav">
                        <div class="nav_col">
                            <span class="footer_nav_trigger">Danh mục sản phẩm</span>
...
{{--                                    <li><a href="/docs/5.8/broadcasting">Echo</a></li>--}}
{{--                                    <li><a href="/docs/5.8/valet">Valet</a></li>--}}
{{--                                    <li><a href="/docs/5.8/mix">Mix</a></li>--}}
{{--                                    <li><a href="https://spark.laravel.com">Spark</a></li>--}}
{{--                                    <li><a href="/docs/5.8/billing">Cashier</a></li>--}}
{{--                                    <li><a href="/docs/5.8/homestead">Homestead</a></li>--}}
{{--                                    <li><a href="/docs/5.8/dusk">Dusk</a></li>--}}
{{--                                    <li><a href="/docs/5.8/passport">Passport</a></li>--}}
{{--                                    <li><a href="/docs/5.8/scout">Scout</a></li>--}}
{{--                                    <li><a href="/docs/5.8/socialite">Socialite</a></li>--}}
{{--                                    <li><a href="/docs/5.8/telescope">Telescope</a></li>--}}
{{--                                </ul>--}}
{{--                            </div>--}}
{{--                        </div>--}}
                    </div>
